...
ai02_2_url2 = [i for i in y_exp]
print("2",[round(i, 2) for i in y_exp])
ai02_2_url3 = [round(i, 2) for i in y_exp]
sum_exp_yi = sum(y_exp)
print("3",round(sum_exp_yi, 2))
ai02_2_url4 = round(sum_exp_yi, 2)
print("4",[round(i) for i in y_exp])
ai02_2_url5 = [round(i) for i in y_exp]
