...
dataset = pd.read_csv('data/ai_m01_ch07/data.csv')
print (dataset.head())
ai07_2_url1 = dataset.head()
print("initial order")
print(dataset)
ai07_2_url2 = dataset
...
ai07_plot_url1 = b64encode(img.getvalue()).decode('ascii')
