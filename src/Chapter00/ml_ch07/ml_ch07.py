...
ml07_url1 = '10-fold cross validation:'
ml07_url2 = []
ctr=0
for clf, label in zip([pipe1, clf2, pipe3], clf_labels):
    ...
    ml07_url2.insert(ctr, "ROC AUC: %0.2f (+/- %0.2f) [%s]"
          % (scores.mean(), scores.std(), label))
    ctr+1;
...
for clf, label in zip(all_clf, clf_labels):
    ...
    print("ROC AUC: %0.2f (+/- %0.2f) [%s]"
          % (scores.mean(), scores.std(), label))
    ml07_url3.insert(ctr, "ROC AUC: %0.2f (+/- %0.2f) [%s]"
          % (scores.mean(), scores.std(), label))
    ctr+1
...
ml07_url7 = 'Decision tree train/test accuracies %.3f/%.3f' % (tree_train, tree_test)
...
print('Bagging train/test accuracies %.3f/%.3f'
      % (bag_train, bag_test))
ml07_url8 = 'Bagging train/test accuracies %.3f/%.3f' % (bag_train, bag_test)
...
ml07_plot_url4 = b64encode(img.getvalue()).decode('ascii')
