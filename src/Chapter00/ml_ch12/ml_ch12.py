...
X_train, y_train = load_mnist('data/ml_ch12/', kind='train')
print('Rows: %d, columns: %d' % (X_train.shape[0], X_train.shape[1]))
ml12_url1 = 'Rows: %d, columns: %d' % (X_train.shape[0], X_train.shape[1])

# In[11]:


X_test, y_test = load_mnist('data/ml_ch12/', kind='t10k')
print('Rows: %d, columns: %d' % (X_test.shape[0], X_test.shape[1]))
ml12_url2 = 'Rows: %d, columns: %d' % (X_test.shape[0], X_test.shape[1])
...
ml12_plot_url1 = b64encode(img.getvalue()).decode('ascii')
...
ml12_plot_url2 = b64encode(img.getvalue()).decode('ascii')
...
ml12_url3 = 'a & b', np.may_share_memory(a, b)

a = np.arange(5)
print('a & b', np.may_share_memory(a, b))
ml12_url4 = 'a & b', np.may_share_memory(a, b)
...
ml12_plot_url3 = b64encode(img.getvalue()).decode('ascii')
...
ml12_plot_url4 = b64encode(img.getvalue()).decode('ascii')
...
ml12_url5 = 'Test accuracy: %.2f%%' % (acc * 100)
...
ml12_plot_url5 = b64encode(img.getvalue()).decode('ascii')
