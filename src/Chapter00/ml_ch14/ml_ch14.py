...
with tf.Session(graph=g) as sess:
    print('Ranks:', 
          ...
          r2.eval(), 
          r3.eval())
    ml14_url2 = 'Ranks:', r1.eval(), r2.eval(), r3.eval()
...
ml14_plot_url2 = b64encode(img.getvalue()).decode('ascii')
...
ml14_plot_url3 = b64encode(img.getvalue()).decode('ascii')
